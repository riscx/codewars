...
def tribonacci(signature, n):
    # Signature is a list
    # Needs 3 items in list, counts those 3 part of n
    # if 0 returns empty
    # ouput needs to return list with the 3 numbers in
    # just need to add to list
    
    #if to see if sum needed past 3, 1st 3 is base provided
    if n > 3:
        # for loop to to keep track of numbers needed to get to.
        for i in range(n):
            # add last 3 items in the list
            num = sum(signature[-3:])
            # reuse signature variable, waste not
